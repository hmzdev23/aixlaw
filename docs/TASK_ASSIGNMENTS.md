...
|----|-------|-------|--------|-------------------|----------------------------------|--------|
| **T1** | Foundation & Marketing Shell | Hamza | `hamza` | — | Cold open shell, mode tabs, FR/EN chrome, HeroVideo.MD | Planned |
| **T2** | Cockpit UI | Hamza | `hamza` | T1 shell, contracts for tree data | Pile, eval, calendar, Ghost, bloom, walkaway, TrueSight UI, Compliance panel, Play Best Line UI, docx/pdf panes, voice, timeline | Planned |
...
| **T6** | TrueSight + Multi-Regime Compliance + Bilingual | Aditya | `aditya` | T4/T5 text surfaces | TrueSight intercept, OSFI/PIPEDA/Law25, PIA FR/EN, i18n content | Planned |
| **T7** | Inbound Triggers + Auth + Personas | Will | `will` | — | Gmail/Slack trigger, calendar deadline, personas, fixture paths | Planned |
...
| **T9** | Execution Engine + Spellbook + Notary | Will | `will` | T8 handoff | Stripe CAD, provisioning, notary queue, timeline, Spellbook client | Planned |
